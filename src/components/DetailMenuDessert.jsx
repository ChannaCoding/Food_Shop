...
const DetailMenuDessert = () => {
    ...
    return (
      <div className="w-full min-h-screen flex items-center justify-center bg-[#FDFDFD]">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-[#2D4A22] mb-4 uppercase tracking-widest">Dessert Not Found</h2>
          <Link to="/MenuDessert" className="text-[#F58220] font-black text-xs uppercase tracking-widest underline">
            Back to Menu
          </Link>
        </div>
      </div>
  ...
  const addToCart = () => {
    ...
    const index = cart.findIndex((item) => item.id === dessert.id && item.type === 'dessert');
    ...
    setToastMessage(`${dessert.name} added to cart!`);
    setShowToast(true);
  };
          ...
          <div className="flex flex-col">
            ...
            <div className="border-b border-gray-100 pb-8 mb-8">
              <div className="flex items-center gap-2 text-[#F58220] text-[10px] font-black uppercase tracking-[0.2em] mb-4">
                <BiLeaf size={16} />
                <span>Authentic {dessert.category}</span>
              </div>
            ...
            <div className="flex items-end gap-4 mb-10">
              ...
              <span className="text-lg text-gray-300 line-through font-medium mb-1">${(dessert.price * 1.5).toFixed(2)}</span>
            ...
            <div className="grid grid-cols-3 gap-1 pt-8 border-t border-gray-100">
              <div className="flex flex-col items-center p-4 border-r border-gray-100">
                ...
                <span className="text-[9px] font-black text-[#2D4A22] uppercase tracking-tighter">Safe Delivery</span>
              </div>
              <div className="flex flex-col items-center p-4 border-r border-gray-100">
                <BiTime className="text-[#F58220] mb-2" size={24} />
                <span className="text-[9px] font-black text-[#2D4A22] uppercase tracking-tighter">Instant Prep</span>
              </div>
              <div className="flex flex-col items-center p-4">
                <MdVerified className="text-[#F58220] mb-2" size={24} />
                <span className="text-[9px] font-black text-[#2D4A22] uppercase tracking-tighter">Handmade</span>
              </div>
            </div>
